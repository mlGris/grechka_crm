...
from sqlalchemy import select, Uuid, update as sqlalchemy_update, delete as sqlalchemy_delete, func
...
class BaseDAO[T_model: Base]:
    model: T_model #Устанавливается в дочернем классе
